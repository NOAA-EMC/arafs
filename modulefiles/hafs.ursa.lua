...
fms_ver=os.getenv("fms_ver") or "2024.02"
...
gftl_shared_ver=os.getenv("gftl_shared_ver") or "1.9.0"
load(pathJoin("gftl-shared", gftl_shared_ver))

yafyaml_ver=os.getenv("yafyaml_ver") or "0.2.5"
load(pathJoin("libyaml", yafyaml_ver))

mapl_ver=os.getenv("mapl_ver") or "2.53.0-esmf-8.8.0"
...
xarray_ver=os.getenv("xarray_ver") or "2024.7.0"
load(pathJoin("py-xarray", xarray_ver))

netcdf4_ver=os.getenv("netcdf4_ver") or "1.7.1.post2"
