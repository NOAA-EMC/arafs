...
HOMEhafs=/gpfs/f6/drsa-hurr1/world-shared/save/${USER}/arafs
...
confopts="config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_hfsa ../parm/hfsa_ar2.conf \
dir.COMrtofs=/gpfs/f6/drsa-hurr1/world-shared/noscrub/hafs-input/COMRTOFSv2.5_new"
## Technical testing for Helene
./run_hafs.py ${opts} 2024092412 09L HISTORY ${confopts} \
    config.NHRS=6 config.scrub_work=no config.scrub_com=no config.run_emcgraphics=no
